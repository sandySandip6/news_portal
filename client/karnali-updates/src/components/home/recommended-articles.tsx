        ...
        {items.map((article) => (
          <li key={article.id}>
            <Link
              ...
              className="group flex gap-4 rounded-xl border border-border bg-card p-3 transition hover:border-red-600/30 hover:bg-muted/50"
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <h3 className="mt-1 line-clamp-2 font-heading text-sm font-bold leading-snug group-hover:text-red-600 sm:text-base">
                  {article.title}
                </h3>
                {article.excerpt ? (
