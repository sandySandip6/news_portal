      ...
      <ol className="space-y-0 overflow-hidden rounded-2xl border border-border bg-card">
        {items.map((article, i) => (
          <li key={article.id} className="border-b border-border last:border-b-0">
            ...
            >
              <span className="flex size-10 shrink-0 items-center justify-center rounded-full bg-red-600 text-lg font-black text-white">
                {i + 1}
              </span>
              ...
              <div className="min-w-0 flex-1">
                ...
                <h3 className="mt-1 font-heading text-base font-bold leading-snug hover:text-red-600">
                  {article.title}
                </h3>
